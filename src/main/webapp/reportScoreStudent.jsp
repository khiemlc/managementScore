...
<html>
    ...
    <body>
            ...
            <tbody>
                <%
                    while (rsSubject.next()) {
                        ...
                        ResultSet rsScore1 = tDAO.getScoreByStudent(student_id, subject_id, 1);
                        ResultSet rsScore2 = tDAO.getScoreByStudent(student_id, subject_id, 2);
        ...
        <%
            ...
            String conduct = sDAO.getConduct(classes, student_id, school_id);
            if (conduct.equals("")) {
                title = "Not assign";
            } else {
