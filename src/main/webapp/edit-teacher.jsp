        ...
        <div class="container">
            <form action="AdminController" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<%= teacher.getName()%>">
                </div>
                <div class="form-group">
                    <label for="name">Email:</label>
                    <input type="text" id="email" name="email" value="<%=teacher.getEmail()%>" >
                    <%
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" value="<%=teacher.getPhone()%>" >
                    <%
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="birthday" name="birthday" value="<%=teacher.getBirthday()%>">
                </div>
                <div class="form-group">
                    <label for="address">Address:</label>
                    <input type="text" id="address" name="address" value="<%=teacher.getAddress()%>">
                </div>
