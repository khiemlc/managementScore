...
<body>
    ...
    <form action="AdminController" method="post">
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" value="<%= (oldData != null) ? oldData.getName() : "" %>">
        </div>
        <div class="form-group">
            <label for="name">Email:</label>
          <input type="text" id="email" name="email" value="<%= (oldData != null) ? oldData.getEmail() : "" %>">
              <%
        ...
        <div class="form-group">
           ...
           <input type="text" id="phone" name="phone" value="<%= (oldData != null) ? oldData.getPhone() : "" %>">
              <%
        ...
        <div class="form-group">
            ...
            <input type="date" id="birthday" name="birthday" value="<%= (oldData != null) ? oldData.getBirthday() : "" %>">
        </div>
        <div class="form-group">
            <label for="address">Address:</label>
           <input type="text" id="address" name="address" value="<%= (oldData != null) ? oldData.getAddress() : "" %>">
        </div>
