        ...
        <div class="container">
            ...
            <form action="AdminController" method="post">
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" value="<%= (oldData != null) ? oldData.getName() : ""%>" required>
                </div>

                <div class="form-group">
                    <label for="email">Email:</label>
                    <input type="email" id="email" name="email" value="<%= (oldData != null) ? oldData.getEmail() : ""%>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="birthday" name="birthday" value="<%= (oldData != null) ? oldData.getBirthday() : ""%>" required>
                </div>

                <div class="form-group">
                    <label for="phone_number">Phone Number:</label>
                    <input type="text" id="phone_number" name="phone" value="<%= (oldData != null) ? oldData.getPhone_number() : ""%>" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address" name="address" value="<%= (oldData != null) ? oldData.getAddress() : ""%>" required>
                </div>
